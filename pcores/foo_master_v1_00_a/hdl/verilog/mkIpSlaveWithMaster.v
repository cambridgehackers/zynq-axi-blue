...
//
// On Mon Dec 10 09:27:46 EST 2012
//
...
module mkIpSlaveWithMaster(CLK,
  ...
  reg [35 : 0] CASE_requestFifo_fifoD_OUT_BITS_35_TO_32_11_C_ETC__q1;
  reg [31 : 0] IF_get_addr_EQ_0x24_50_THEN_getWordCount_44_EL_ETC___d369;
  wire [127 : 0] dutWrapper_dut_axiTester_valueReg_3_MUL_7___d34;
  wire [63 : 0] dutWrapper_dut_valueReg_0_MUL_7___d71;
  wire [35 : 0] newval__h11968, x__h12343;
  wire [31 : 0] result__h12461,
		v___1__h12171,
		v___1__h12185,
		v___1__h6654,
		v___1__h6660,
		...
		y__h4740,
		y__h9247;
  wire [7 : 0] spliced_bits__h7009, spliced_bits__h8464;
  wire [3 : 0] spliced_bits__h6668,
	       spliced_bits__h6701,
	       spliced_bits__h6824,
	       spliced_bits__h6857,
	       spliced_bits__h8121,
	       ...
	       spliced_bits__h8277,
	       spliced_bits__h8310;
  wire NOT_dutWrapper_dut_readCountReg_9_ULT_dutWrapp_ETC___d87,
       dutWrapper_dut_axiTester_readCountReg_1_EQ_dut_ETC___d63,
       dutWrapper_dut_axiTester_writeCountReg_8_EQ_du_ETC___d40,
       get_addr_ULT_0x100___d428,
       put_addr_ULT_0x100___d323;
  ...
  assign get =
	     get_addr_ULT_0x100___d428 ?
	       IF_get_addr_EQ_0x24_50_THEN_getWordCount_44_EL_ETC___d369 :
	       v___1__h12171 ;
  assign RDY_get = 1'd1 ;
  ...
  assign MUX_dutWrapper_dut_testCompletedReg$write_1__SEL_1 =
	     WILL_FIRE_RL_dutWrapper_dut_receiveTestData &&
	     NOT_dutWrapper_dut_readCountReg_9_ULT_dutWrapp_ETC___d87 ;
  assign MUX_responseFifo_count$write_1__SEL_1 =
	     EN_get && !get_addr_ULT_0x100___d428 &&
	     responseFifo_fifo$EMPTY_N ;
  ...
  assign MUX_dutWrapper_dut_fifoFromAxi_boundsReg$write_1__VAL_2 =
	     dutWrapper_dut_fifoToAxi_baseReg + y__h9247 ;
  ...
  assign MUX_dutWrapper_dut_fifoToAxi_dfifo$enq_1__VAL_1 =
	     { 32'd0, dutWrapper_dut_valueReg_0_MUL_7___d71[31:0] } ;
  ...
  assign MUX_responseFifo_count$write_1__VAL_1 =
	     (responseFifo_count == 32'd1) ? 32'd0 : x__h5901 ;
  ...
  assign dutWrapper_dut_axiTester_valueReg$D_IN =
	     WILL_FIRE_RL_dutWrapper_dut_axiTester_enqTestData ?
	       dutWrapper_dut_axiTester_valueReg_3_MUL_7___d34[63:0] :
	       64'd13 ;
  ...
  assign dutWrapper_dut_valueReg$D_IN =
	     dutWrapper_dut_valueReg_0_MUL_7___d71[31:0] ;
  ...
  assign dutWrapper_junkReqReg$EN =
	     requestFifo_fifo$EMPTY_N &&
	     CASE_requestFifo_fifoD_OUT_BITS_35_TO_32_11_C_ETC__q1[35:32] >
	     4'd11 ;
  ...
  assign putWordCount$EN = EN_put && !put_addr_ULT_0x100___d323 ;
  ...
  assign requestFifo_buff$D_IN =
	     (requestFifo_count == 32'd1) ?
	       ...
	       newval__h11968 ;
  assign requestFifo_buff$EN = EN_put && !put_addr_ULT_0x100___d323 ;

  // register requestFifo_count
  assign requestFifo_count$D_IN =
	     (requestFifo_count == 32'd1) ? 32'd0 : x__h12069 ;
  assign requestFifo_count$EN = EN_put && !put_addr_ULT_0x100___d323 ;
  ...
  always@(requestFifo_fifo$D_OUT or
	  ...
	  v___1__h6654 or
	  v___1__h6660 or
	  spliced_bits__h6668 or
	  spliced_bits__h6701 or
	  spliced_bits__h6824 or
	  spliced_bits__h6857 or
	  spliced_bits__h7009 or
  ...
  begin
    case (requestFifo_fifo$D_OUT[11:0])
      ...
      12'h00C: dutWrapper_dut_fifoStatusFifo$D_IN = v___1__h6654;
      12'h010: dutWrapper_dut_fifoStatusFifo$D_IN = v___1__h6660;
      12'h014:
	  dutWrapper_dut_fifoStatusFifo$D_IN =
	      { 16'd0, spliced_bits__h6668, 8'd0, spliced_bits__h6701 };
      12'h018:
	  dutWrapper_dut_fifoStatusFifo$D_IN =
	      { 16'd0, spliced_bits__h6824, 8'd0, spliced_bits__h6857 };
      12'h01C:
	  dutWrapper_dut_fifoStatusFifo$D_IN =
	      { 8'd187,
		spliced_bits__h7009,
  ...
  always@(WILL_FIRE_RL_dutWrapper_dut_enqTestData or
	  ...
	  dutWrapper_dut_axiTester_valueReg_3_MUL_7___d34)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dutWrapper_dut_enqTestData:
  ...
  always@(requestFifo_fifo$D_OUT or
	  ...
	  v___1__h8107 or
	  v___1__h8113 or
	  spliced_bits__h8121 or
	  spliced_bits__h8154 or
	  spliced_bits__h8277 or
	  spliced_bits__h8310 or
	  spliced_bits__h8464 or
  ...
  begin
    case (requestFifo_fifo$D_OUT[11:0])
	  ...
	  dutWrapper_dut_fromFifoStatusFifo$D_IN =
	      dutWrapper_dut_fifoFromAxi_ptrReg;
      12'h00C: dutWrapper_dut_fromFifoStatusFifo$D_IN = v___1__h8107;
      12'h010: dutWrapper_dut_fromFifoStatusFifo$D_IN = v___1__h8113;
      12'h014:
	  dutWrapper_dut_fromFifoStatusFifo$D_IN =
	      { 16'd0, spliced_bits__h8121, 8'd0, spliced_bits__h8154 };
      12'h018:
	  dutWrapper_dut_fromFifoStatusFifo$D_IN =
	      { 16'd0, spliced_bits__h8277, 8'd0, spliced_bits__h8310 };
      12'h01C:
	  dutWrapper_dut_fromFifoStatusFifo$D_IN =
	      { 8'd187,
		spliced_bits__h8464,
  ...
  assign requestFifo_fifo$ENQ =
	     EN_put && !put_addr_ULT_0x100___d323 &&
	     requestFifo_count == 32'd1 ;
  ...
  assign rf$WE = EN_put && put_addr_ULT_0x100___d323 ;

  // remaining internal signals
  assign NOT_dutWrapper_dut_readCountReg_9_ULT_dutWrapp_ETC___d87 =
	     dutWrapper_dut_readCountReg >= y__h4740 ;
  assign dutWrapper_dut_axiTester_readCountReg_1_EQ_dut_ETC___d63 =
	     dutWrapper_dut_axiTester_readCountReg == y__h4453 ;
  assign dutWrapper_dut_axiTester_valueReg_3_MUL_7___d34 =
	     dutWrapper_dut_axiTester_valueReg * 64'd7 ;
  assign dutWrapper_dut_axiTester_writeCountReg_8_EQ_du_ETC___d40 =
	     dutWrapper_dut_axiTester_writeCountReg == y__h4453 ;
  assign dutWrapper_dut_valueReg_0_MUL_7___d71 =
	     dutWrapper_dut_valueReg * 32'd7 ;
  assign get_addr_ULT_0x100___d428 = get_addr < 12'h100 ;
  assign newval__h11968 = { put_v, requestFifo_buff[35:32] } ;
  assign put_addr_ULT_0x100___d323 = put_addr < 12'h100 ;
  assign result__h12461 =
	     { rf$D_OUT_2[31:17],
	       responseFifo_fifo$FULL_N,
	       rf$D_OUT_2[15:1],
	       interrupted } ;
  assign spliced_bits__h6668 =
	     dutWrapper_dut_fifoToAxi_axiBrespFifo$FULL_N ? 4'h0 : 4'hF ;
  assign spliced_bits__h6701 =
	     dutWrapper_dut_fifoToAxi_axiBrespFifo$EMPTY_N ? 4'h1 : 4'hE ;
  assign spliced_bits__h6824 =
	     dutWrapper_dut_fifoToAxi_dfifo$FULL_N ? 4'h0 : 4'hF ;
  assign spliced_bits__h6857 =
	     dutWrapper_dut_fifoToAxi_dfifo$EMPTY_N ? 4'h1 : 4'hE ;
  assign spliced_bits__h7009 =
	     dutWrapper_dut_fifoToAxi_operationInProgress ? 8'hAA : 8'h11 ;
  assign spliced_bits__h8121 =
	     dutWrapper_dut_fifoFromAxi_axiRrespFifo$FULL_N ? 4'h0 : 4'hF ;
  assign spliced_bits__h8154 =
	     dutWrapper_dut_fifoFromAxi_axiRrespFifo$EMPTY_N ? 4'h1 : 4'hE ;
  assign spliced_bits__h8277 =
	     dutWrapper_dut_fifoFromAxi_rfifo$FULL_N ? 4'h0 : 4'hF ;
  assign spliced_bits__h8310 =
	     dutWrapper_dut_fifoFromAxi_rfifo$EMPTY_N ? 4'h1 : 4'hE ;
  assign spliced_bits__h8464 =
	     dutWrapper_dut_fifoFromAxi_operationInProgress ? 8'hAA : 8'h11 ;
  assign v___1__h12171 =
	     responseFifo_fifo$EMPTY_N ? v___1__h12185 : 32'h050A050A ;
  assign v___1__h12185 =
	     responseFifo_fifo$EMPTY_N ? x__h12343[31:0] : 32'h050A050A ;
  assign v___1__h6654 = { 24'd0, dutWrapper_dut_fifoToAxi_burstCountReg } ;
  assign v___1__h6660 =
	     dutWrapper_dut_fifoToAxi_enabledReg ?
	       32'hEEEEEEEE :
	       32'hDDDDDDDD ;
  assign v___1__h8107 = { 24'd0, dutWrapper_dut_fifoFromAxi_burstCountReg } ;
  assign v___1__h8113 =
	     dutWrapper_dut_fifoFromAxi_enabledReg ?
	       32'hEEEEEEEE :
	       32'hDDDDDDDD ;
  assign x__h12069 = requestFifo_count + 32'd1 ;
  assign x__h12343 = responseFifo_fifo$D_OUT >> x__h12347 ;
  assign x__h12347 = { responseFifo_count[26:0], 5'd0 } ;
  assign x__h5901 = responseFifo_count + 32'd1 ;
  assign y__h4453 = dutWrapper_dut_axiTester_numWordsReg - 32'd1 ;
  assign y__h4740 = dutWrapper_dut_numWordsReg - 32'd1 ;
  assign y__h9247 = { requestFifo_fifo$D_OUT[28:0], 3'd0 } ;
  always@(get_addr or
	  rf$D_OUT_2 or
	  result__h12461 or
  ...
  begin
    case (get_addr)
	  ...
	  IF_get_addr_EQ_0x24_50_THEN_getWordCount_44_EL_ETC___d369 =
	      getWordCount;
      default: IF_get_addr_EQ_0x24_50_THEN_getWordCount_44_EL_ETC___d369 =
		   rf$D_OUT_2;
    endcase
  end
  ...
  begin
    case (requestFifo_fifo$D_OUT[35:32])
	  ...
	  CASE_requestFifo_fifoD_OUT_BITS_35_TO_32_11_C_ETC__q1 =
	      requestFifo_fifo$D_OUT;
      default: CASE_requestFifo_fifoD_OUT_BITS_35_TO_32_11_C_ETC__q1 =
		   { 4'd11, requestFifo_fifo$D_OUT[31:0] };
    endcase
  end
