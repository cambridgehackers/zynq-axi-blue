...
//
// On Mon Jan 21 11:35:06 EST 2013
//
...
module mkIpSlaveWithMaster(CLK_hdmi_ref_clk,
  ...
  wire requestFifo_fifo_pwDequeue$whas, requestFifo_fifo_wDataIn$whas;
  ...
  wire [97 : 0] x__h14337;
  wire [35 : 0] newval__h13847, x__h710;
  wire [31 : 0] IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532,
  ...
  wire NOT_dutWrapper_dut_hdmiTpg_lineCount_09_ULT_du_ETC___d118,
       ...
       dutWrapper_dut_hdmiTpg_pixelCount_11_EQ_dutWra_ETC___d525,
       requestFifo_fifo_rRdPtr_1_EQ_requestFifo_fifo__ETC___d308,
       requestFifo_fifo_rRdPtr_1_PLUS_8_99_EQ_request_ETC___d534,
       x__h7275,
       x__h7285;
  ...
  begin
    case (ctrl_get_addr)
      ...
      12'h020: ctrl_get = x__h13582 | y__h13583;
  ...
  // actionvalue method fifo_get
  assign fifo_get = responseFifo_fifo$EMPTY_N ? v___1__h14092 : 32'h050A050A ;
  ...
  assign requestFifo_fifo_wDataIn$whas =
	     EN_fifo_put &&
	     !requestFifo_fifo_rRdPtr_1_PLUS_8_99_EQ_request_ETC___d534 &&
  ...
  assign requestFifo_count$D_IN =
	     (requestFifo_count == 32'd1) ? 32'd0 : x__h13948 ;
  ...
  assign requestFifo_fifo_rCache$EN = requestFifo_fifo_wDataIn$whas ;
  ...
  assign requestFifo_fifo_rWrPtr$EN = requestFifo_fifo_wDataIn$whas ;

  // register responseFifo_count
  assign responseFifo_count$D_IN =
	     (responseFifo_count == 32'd3) ? 32'd0 : x__h14196 ;
  ...
  assign requestFifo_fifo_memory$WEA = requestFifo_fifo_wDataIn$whas ;
  ...
  assign IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532 =
  ...
  assign dutWrapper_dut_hdmiTpg_pixelCount_11_EQ_dutWra_ETC___d525 =
	     dutWrapper_dut_hdmiTpg_pixelCount ==
  ...
  assign newval__h13847 = { fifo_put_v, requestFifo_buff[35:32] } ;
  ...
  assign requestFifo_fifo_rRdPtr_1_PLUS_8_99_EQ_request_ETC___d534 =
	     requestFifo_fifo_rRdPtr + 5'd8 == requestFifo_fifo_rWrPtr ;
  assign result__h13621 =
	     { rf$D_OUT_2[31:17],
	       responseFifo_fifo$FULL_N,
	       rf$D_OUT_2[15:1],
	       interrupted } ;
  ...
  assign spliced_bits__h3938 =
	     { 16'd0,
	       dutWrapper_dut_frameBuffer_nextFbc[44:37],
	       dutWrapper_dut_frameBuffer_nextFbc[44:37] } ;
  assign v___1__h14092 =
	     responseFifo_fifo$EMPTY_N ? x__h14337[31:0] : 32'h050A050A ;
  ...
  assign x__h13582 = x__h13584 | y__h13585 ;
  assign x__h13584 = x__h13586 | y__h13587 ;
  assign x__h13586 =
	     { IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532[31],
	       2'd3,
	       IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532[28],
	       1'd1,
	       IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532[26:23],
	       1'd1,
	       IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532[21:19],
	       3'd7,
	       IF_responseFifo_fifo_i_notFull__04_THEN_0x20_E_ETC___d532[15:0] } ;
  assign x__h13948 = requestFifo_count + 32'd1 ;
  assign x__h14196 = responseFifo_count + 32'd1 ;
  assign x__h14337 = responseFifo_fifo$D_OUT >> x__h14341 ;
  assign x__h14341 = { responseFifo_count[26:0], 5'd0 } ;
  assign x__h710 =
	     requestFifo_fifo_wDataIn$whas ?
  ...
  assign y__h13585 =
	     requestFifo_fifo_rRdPtr_1_PLUS_8_99_EQ_request_ETC___d534 ?
	       32'd0 :
	       32'h00000002 ;
  assign y__h13587 = responseFifo_fifo$EMPTY_N ? 32'h00000010 : 32'd0 ;
