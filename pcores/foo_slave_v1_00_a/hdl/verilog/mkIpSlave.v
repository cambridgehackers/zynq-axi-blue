...
//
// On Fri Nov 30 14:25:43 EST 2012
//
...
module mkIpSlave(CLK,
  ...
  reg [31 : 0] CASE_get_addr_rfD_OUT_2_0x0_result011_0x10_du_ETC__q1;
  wire [65 : 0] newval__h1550;
  wire [32 : 0] x__h1960;
  wire [31 : 0] result__h2011,
		v___1__h1752,
		x__h1651,
		x__h1849,
		x__h1964,
  ...
  assign get =
	     get_addr_ULT_0x100___d88 ?
	       CASE_get_addr_rfD_OUT_2_0x0_result011_0x10_du_ETC__q1 :
	       v___1__h1752 ;
  ...
  assign MUX_dutWrapper_dut_resultReg$write_1__VAL_2 =
	     { 1'd1, requestFifo_fifo$D_OUT[63:32] | y__h833 } ;

  // register dutWrapper_dut_resultReg
  always@(WILL_FIRE_RL_dutWrapper_handleiorrequest or
	  MUX_dutWrapper_dut_resultReg$write_1__VAL_1 or
	  WILL_FIRE_RL_dutWrapper_handleiorShiftrequest or
  ...
  // submodule responseFifo_fifo
  assign responseFifo_fifo$D_IN = { 1'd0, dutWrapper_dut_resultReg[31:0] } ;
  assign responseFifo_fifo$ENQ = WILL_FIRE_RL_dutWrapper_resultresponse ;
  ...
  assign newval__h1550 = { put_v, requestFifo_buff[65:32] } ;
  assign put_addr_ULT_0x100___d36 = put_addr < 12'h100 ;
  assign result__h2011 = { rf$D_OUT_2[31:1], interrupted } ;
  assign v___1__h1752 = responseFifo_fifo$EMPTY_N ? x__h1960[31:0] : 32'd0 ;
  assign x__h1651 = requestFifo_count + 32'd1 ;
  assign x__h1849 = responseFifo_count + 32'd1 ;
  assign x__h1960 = responseFifo_fifo$D_OUT >> x__h1964 ;
  assign x__h1964 = { responseFifo_count[26:0], 5'd0 } ;
  assign y__h833 = { requestFifo_fifo$D_OUT[15:0], 16'd0 } ;
  always@(get_addr or
	  rf$D_OUT_2 or
	  result__h2011 or
  ...
  begin
    case (get_addr)
	  ...
	  CASE_get_addr_rfD_OUT_2_0x0_result011_0x10_du_ETC__q1 =
	      getWordCount;
      default: CASE_get_addr_rfD_OUT_2_0x0_result011_0x10_du_ETC__q1 =
		   rf$D_OUT_2;
    endcase
  end
