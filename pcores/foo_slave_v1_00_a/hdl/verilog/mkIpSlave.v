...
//
// On Thu Nov 29 15:14:40 EST 2012
//
...
module mkIpSlave(CLK,
  ...
  wire MUX_dutWrapper_respReg$write_1__SEL_2, MUX_interrupted$write_1__SEL_1;

  // remaining internal signals
  reg [31 : 0] CASE_get_addr_rfD_OUT_2_0x0_result108_0x10_du_ETC__q1;
  wire [63 : 0] longval__h1802;
  wire [31 : 0] result__h2108,
		v__h2184,
		x__h1756,
		x__h2036,
		x__h2215,
		y_avValue__h2178;
  wire get_addr_ULT_0x100___d77, put_addr_ULT_0x100___d30;
  ...
  // actionvalue method get
  assign get =
	     get_addr_ULT_0x100___d77 ?
	       CASE_get_addr_rfD_OUT_2_0x0_result108_0x10_du_ETC__q1 :
	       y_avValue__h2178 ;
  assign RDY_get = 1'd1 ;
  ...
  assign getWordCount$EN = EN_get && !get_addr_ULT_0x100___d77 ;
  ...
  assign putWordCount$EN = EN_put && !put_addr_ULT_0x100___d30 ;
  ...
  assign requestFifo_buff$D_IN =
	     (requestFifo_count == 32'd1) ?
	       ...
	       longval__h1802 ;
  assign requestFifo_buff$EN = EN_put && !put_addr_ULT_0x100___d30 ;

  // register requestFifo_count
  assign requestFifo_count$D_IN =
	     (requestFifo_count == 32'd1) ? 32'd0 : x__h1756 ;
  assign requestFifo_count$EN = EN_put && !put_addr_ULT_0x100___d30 ;

  // register responseFifo_count
  assign responseFifo_count$D_IN =
	     (responseFifo_count == 32'd0) ? responseFifo_count : x__h2036 ;
  assign responseFifo_count$EN =
	     EN_get && !get_addr_ULT_0x100___d77 &&
	     responseFifo_fifo$EMPTY_N ;

  // submodule requestFifo_fifo
  assign requestFifo_fifo$D_IN = longval__h1802 ;
  assign requestFifo_fifo$ENQ =
	     EN_put && !put_addr_ULT_0x100___d30 &&
	     requestFifo_count == 32'd1 ;
  ...
  assign rf$WE = EN_put && put_addr_ULT_0x100___d30 ;

  // remaining internal signals
  assign get_addr_ULT_0x100___d77 = get_addr < 12'h100 ;
  assign longval__h1802 = { put_v, requestFifo_buff[63:32] } ;
  assign put_addr_ULT_0x100___d30 = put_addr < 12'h100 ;
  assign result__h2108 = { rf$D_OUT_2[31:1], interrupted } ;
  assign v__h2184 = responseFifo_fifo$D_OUT >> x__h2215 ;
  assign x__h1756 = requestFifo_count + 32'd1 ;
  assign x__h2036 = responseFifo_count + 32'd1 ;
  assign x__h2215 = { responseFifo_count[26:0], 5'd0 } ;
  assign y_avValue__h2178 = responseFifo_fifo$EMPTY_N ? v__h2184 : 32'd0 ;
  always@(get_addr or
	  rf$D_OUT_2 or
	  result__h2108 or
  ...
  begin
    case (get_addr)
	  ...
	  CASE_get_addr_rfD_OUT_2_0x0_result108_0x10_du_ETC__q1 =
	      getWordCount;
      default: CASE_get_addr_rfD_OUT_2_0x0_result108_0x10_du_ETC__q1 =
		   rf$D_OUT_2;
    endcase
  end
