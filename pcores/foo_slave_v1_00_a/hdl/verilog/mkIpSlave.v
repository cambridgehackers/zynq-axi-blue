...
//
// On Tue Dec  4 09:16:58 EST 2012
//
...
module mkIpSlave(CLK,
  ...
  reg [31 : 0] IF_get_addr_EQ_0x24_0_THEN_getWordCount_4_ELSE_ETC___d104;
  wire [65 : 0] newval__h1974;
  wire [33 : 0] x__h2437;
  wire [31 : 0] requestFifo_fifo_first_BITS_63_TO_32_0_OR_requ_ETC___d131,
		result__h2548,
		v___1__h2177,
		v___1__h2191,
		x__h2075,
		...
		x__h2441,
		y__h1005;
  wire get_addr_ULT_0x100___d124, put_addr_ULT_0x100___d58;
  ...
  // actionvalue method get
  assign get =
	     get_addr_ULT_0x100___d124 ?
	       IF_get_addr_EQ_0x24_0_THEN_getWordCount_4_ELSE_ETC___d104 :
	       v___1__h2177 ;
  assign RDY_get = 1'd1 ;
  ...
  assign MUX_dutWrapper_dut_result2Reg$write_1__VAL_1 =
	     { 1'd1,
	       requestFifo_fifo_first_BITS_63_TO_32_0_OR_requ_ETC___d131[31:4],
	       1'd1,
	       requestFifo_fifo_first_BITS_63_TO_32_0_OR_requ_ETC___d131[2],
	       2'd3 } ;
  ...
  assign getWordCount$EN =
	     EN_get && !get_addr_ULT_0x100___d124 &&
	     responseFifo_fifo$EMPTY_N ;
  ...
  // remaining internal signals
  assign get_addr_ULT_0x100___d124 = get_addr < 12'h100 ;
  assign newval__h1974 = { put_v, requestFifo_buff[65:32] } ;
  assign put_addr_ULT_0x100___d58 = put_addr < 12'h100 ;
  assign requestFifo_fifo_first_BITS_63_TO_32_0_OR_requ_ETC___d131 =
	     requestFifo_fifo$D_OUT[63:32] | y__h1005 ;
  assign result__h2548 = { rf$D_OUT_2[31:1], interrupted } ;
  assign v___1__h2177 =
  ...
  begin
    case (get_addr)
	  ...
	  IF_get_addr_EQ_0x24_0_THEN_getWordCount_4_ELSE_ETC___d104 =
	      getWordCount;
      default: IF_get_addr_EQ_0x24_0_THEN_getWordCount_4_ELSE_ETC___d104 =
		   rf$D_OUT_2;
    endcase
  end
