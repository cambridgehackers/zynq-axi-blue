...
-- Date:              Tue Nov 20 15:09:44 2012 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  -- jamey signals below
  signal mkip_rd_d                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0);
  signal mkip_en_put : std_logic;
  signal mkip_rdy_put : std_logic;
  signal mkip_en_get : std_logic;
  signal mkip_rdy_get : std_logic;
begin
  ...
  slv_write_ack     <= Bus2IP_WrCE(0) or Bus2IP_WrCE(1) or Bus2IP_WrCE(2) or Bus2IP_WrCE(3) or Bus2IP_WrCE(4) or Bus2IP_WrCE(5) or Bus2IP_WrCE(6) or (mkip_en_put and mkip_rdy_put);
  slv_read_ack      <= Bus2IP_RdCE(0) or Bus2IP_RdCE(1) or Bus2IP_RdCE(2) or Bus2IP_RdCE(3) or Bus2IP_RdCE(4) or Bus2IP_RdCE(5) or Bus2IP_RdCE(6) or (mkip_en_get and mkip_rdy_get);
  ...
  begin
    ...
    case slv_reg_read_sel is
      when "10000000" => slv_ip2bus_data <= mkip_rd_d;
  ...
  --JAMEY logic implementation added here

  mkip_en_put <= Bus2IP_WrCE(7);
  mkip_en_get <= Bus2IP_RdCE(7);
  ...
  MK_IP : entity mkIP
    ...
    (CLK => Bus2IP_Clk, 
	    ...
	    put_v => Bus2IP_Data,
	    EN_put => mkip_en_put,
            RDY_put => mkip_rdy_put,

	    EN_get => mkip_en_get,
	    get => mkip_rd_d,
            RDY_get => mkip_rdy_get,
